...
export class ModifierConsultationComponent implements OnInit {
  ...
  fileUploUrl : string; 
   ...
   dataSourceOrientations : MatTableDataSource<any>;
    ...
    /* Table Structure | Orientation médicale */
    displayedColumnsExamens: string[] = ['designation','description','resultat','Action-delete','Action-rapport'];
  ...
  ngOnInit() {
      ...
      this.id_employe = this.data.id_employe;
...
deletePrecription(object){
  ...
  genererOrdonnance() {
      ...
      var splitTitle = doc.splitTextToSize("Lorem ipsu ipsumLorem ipsumLorem ipsumLorem ipsumLorem ipsumLorem ipsumLorem ipsumLorem ipsumLorem ipsumLorem ipsum", 310);
      splitTitle = this.consultation.ordonnance.observation;
      doc.setFontType("normal");
